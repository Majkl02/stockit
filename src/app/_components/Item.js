...
export default function Item({ id }) {
  ...
  return (
    <div
      ...
      className='mb-4 flex cursor-pointer flex-col rounded-2xl bg-gray-300 shadow-2xl transition-all duration-300 ease-in-out hover:-translate-y-1 active:translate-y-0'
    >
